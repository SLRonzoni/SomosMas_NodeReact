...
//REGULAR EXPRESSIONS
const regexUserName=/^[a-zA-Z0-9_-]{4,16}$/ // Letras, numeros, guion y guion_bajo, entre 4 y 16 digitos
...
export { regexUserName,regexUserPassword,regexUserEmail,regexUserPhone,
